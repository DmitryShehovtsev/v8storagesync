...
Плагин для 1C:EDT, предоставляющий возможность синхронизировать проект EDT с хранилищем конфигурации, используя для синхронизации внешнюю утилиту jeweltools.
...
## `v8storage push`
Получает изменения между коммитами HEAD и родительским и помещает их в хранилище конфигурации.

<table>
  <thead>
    <tr>
      <th style="width: 15%;">Опция</th>
      <th style="width: 10%;">Тип</th>
      <th style="width: 35%;">Описание</th>
      <th style="width: 40%;">Пример</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td><code>v8storage -h 7d038f9d18ea83a8351d89caab34011ca1a7485c</code></td>
    </tr>
    <tr>
...
Сама утилита `jeweltools` должна быть установлена отдельно, см. описание в её репозитории выше.
